...
class Message
{
    ...
    public const NO_NAME = 'Введите Имя"';
    public const NO_SURNAME = 'Введите Фамилию';
    public const WRONG_EMAIL_ADDRESS  = 'Не верный адрес электронной почты';
    public const NO_PASSWORD = 'Введите Пароль';
    public const PASSWORDS_DO_NOT_MATCH = 'Пароли не совпадают';
    public const USER_ALREADY_EXISTS = 'Пользователь с таким уже Email существует';
    public const SUCCESS = 'Вы зарегистрировались';
...
class Logger
{
    ...
    public static function regLog()
    {
        ...
        if (existUsers::isRegisteredInPeopleCollection($_POST['email'])) $info[] = Message::USER_ALREADY_EXISTS;
